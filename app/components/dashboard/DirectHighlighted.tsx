...
export default function DirectHighlighted({ tasks }: DirectHighlightedProps) {
  ...
  if (!tasks || tasks.length === 0) {
    return (
      <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-xl p-6 shadow-lg h-full" data-testid="direct-highlighted-empty">
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-xl p-6 shadow-lg h-full" data-testid="direct-highlighted">
