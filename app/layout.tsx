...
export const metadata: Metadata = {
  title: 'DGT - Area de Inteligencia Artificial',
      ...
      <body className="min-h-screen">
        <main className="container mx-auto py-6 px-4 max-w-7xl">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold mb-2 bg-gradient-to-r from-primary to-info bg-clip-text text-transparent drop-shadow-sm tracking-tight py-2">DGT - Area Inteligencia Artificial</h1>
